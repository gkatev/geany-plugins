...
static struct tool_t tools[TOOL_COUNT] =
{
	...
	(struct tool_t) {
		...
		/* We'll make name and tooltip translatable,
		 * in plugin_init, as these must be static. */
		
		.name = "Open Terminal",
		.name_menu = "Open _Terminal",
		.icon = "utilities-terminal-symbolic",
		.tooltip = "Command to open a virtual terminal emulator"
	...
	(struct tool_t) {
		...
		.name = "Open Directory",
		.name_menu = "Open _Directory",
		.icon = "folder-symbolic",
		.tooltip = "Command to open your file manager of choice"
			" (" TOOLTIP_REPLACEMENTS ")",
